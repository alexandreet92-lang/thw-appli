...
Intégration Meta / Instagram : les identifiants (access token, client_secret,
business id, URL OAuth) NE doivent PAS figurer ici. À stocker uniquement dans
les variables d'environnement (Vercel). Les valeurs qui étaient présentes ont
été exposées → à révoquer et régénérer côté Meta.