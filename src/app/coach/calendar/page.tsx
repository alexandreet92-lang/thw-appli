...
export default function CoachCalendar() {
  ...
  return (
    <div style={{ width: '100%', padding: '20px clamp(16px,4vw,40px) 60px', boxSizing: 'border-box', fontFamily: 'DM Sans,sans-serif' }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, color: 'var(--text)', margin: '0 0 4px', fontFamily: 'Syne,DM Sans,sans-serif' }}>Calendrier</h1>
            ...
            return (
              <Link key={it.id} href={`/coach/athlete/${it.athleteId}`} style={{ ...card, display: 'flex', alignItems: 'center', gap: 14, textDecoration: 'none', color: 'inherit', padding: 14 }}>
                <div style={{ width: 58, flexShrink: 0, textAlign: 'center' }}>
                  <div style={{ fontSize: 20, fontWeight: 800, color: 'var(--primary)', fontFamily: 'Syne,DM Sans,sans-serif', lineHeight: 1 }}>{d <= 0 ? 'J' : `J-${d}`}</div>
                </div>
