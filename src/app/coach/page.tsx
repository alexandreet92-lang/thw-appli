    ...
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '18px 16px 60px', fontFamily: 'DM Sans,sans-serif' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 6 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: 'var(--text)', margin: 0, fontFamily: 'Syne,DM Sans,sans-serif' }}>Espace coach</h1>
          <p style={{ fontSize: 12.5, color: 'var(--text-dim)', margin: '2px 0 0' }}>Suis tes athlètes, avec leur accord.</p>
        </div>
