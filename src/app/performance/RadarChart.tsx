  ...
  M: [
    {
      ...
      label: 'Natation',
      unit: 's/100m',
      description: 'Allure natation Triathlon M (1500m) — efficience technique + endurance aérobie',
      benchH: [68, 74, 82, 92, 105, 128],
      benchF: [74, 82, 92, 104, 120, 144],
      lowerBetter: true,
    ...
    },
    {
      ...
      label: 'Vélo',
      unit: 'W/kg',
      description: 'Puissance normalisée sur le segment vélo Triathlon M (40 km)',
      benchH: [5.2, 4.5, 3.8, 3.2, 2.7, 2.1],
      benchF: [4.5, 3.9, 3.3, 2.8, 2.3, 1.8],
      lowerBetter: false,
    ...
    },
    {
      ...
      label: 'Course',
      unit: 's/km',
      description: 'Allure de course Triathlon M (10 km) — capacité à runner compromis',
      benchH: [171, 192, 216, 246, 288, 330],
      benchF: [189, 210, 240, 276, 324, 390],
      lowerBetter: true,
  ...
  '703': [
    {
      ...
      benchH: [70, 79, 91, 107, 126, 158],
      benchF: [79, 88, 102, 117, 136, 171],
      lowerBetter: true,
      inputLabel: 'Allure natation (s/100m)',
      placeholder: 'ex: 100',
    },
    {
      ...
      benchH: [4.5, 3.9, 3.3, 2.8, 2.3, 1.8],
      benchF: [4.0, 3.4, 2.9, 2.4, 2.0, 1.5],
      lowerBetter: false,
      inputLabel: 'Puissance vélo (W/kg)',
      placeholder: 'ex: 3.0',
    },
    {
      ...
      label: 'Course',
      unit: 's/km',
      description: 'Allure semi-marathon 70.3 (21,1 km) — endurance spécifique triathlon',
      benchH: [191, 213, 243, 279, 328, 399],
      benchF: [212, 236, 270, 311, 365, 437],
      lowerBetter: true,
      inputLabel: 'Allure course (s/km)',
      placeholder: 'ex: 270',
    },
  ...
  full: [
    {
      ...
      label: 'Natation',
      unit: 's/100m',
      description: 'Allure natation Ironman (3800m) — économie de nage et aérobie longue durée',
      benchH: [73, 82, 98, 117, 142, 173],
      benchF: [82, 91, 110, 129, 158, 192],
      lowerBetter: true,
      inputLabel: 'Allure natation (s/100m)',
      placeholder: 'ex: 105',
    },
    {
      ...
      benchH: [4.0, 3.5, 3.0, 2.5, 2.1, 1.6],
      benchF: [3.5, 3.0, 2.6, 2.2, 1.8, 1.4],
      lowerBetter: false,
      inputLabel: 'Puissance vélo (W/kg)',
      placeholder: 'ex: 2.7',
    },
    {
      ...
      label: 'Course',
      unit: 's/km',
      description: 'Allure marathon Ironman (42,2 km) — endurance extrême',
      benchH: [219, 244, 277, 320, 370, 447],
      benchF: [225, 253, 292, 338, 406, 488],
      lowerBetter: true,
      inputLabel: 'Allure course (s/km)',
      placeholder: 'ex: 300',
    },
