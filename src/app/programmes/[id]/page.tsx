...
export default function ProgramDetailPage() {
  ...
  if (loading) return <div style={{ padding: 40, fontFamily: 'var(--font-body)', color: 'var(--text-dim)' }}>Chargement…</div>
  if (!p) return (
    <div style={{ width: '100%', maxWidth: 720, margin: '0 auto', padding: 40, boxSizing: 'border-box', fontFamily: 'var(--font-body)', textAlign: 'center' }}>
      ...
      <Link href="/programmes" style={{ color: 'var(--primary)', fontWeight: 700, textDecoration: 'none' }}>Voir le catalogue</Link>
    </div>
  )
  ...
  return (
    <div style={{ paddingTop: 16 }}>
      <div style={{ width: '100%', maxWidth: 720, margin: '0 auto', padding: '0 clamp(16px,4vw,32px)', boxSizing: 'border-box' }}>
        <Link href="/programmes" style={{ display: 'inline-block', color: 'var(--text-mid)', fontFamily: 'var(--font-body)', fontSize: 13, fontWeight: 600, textDecoration: 'none', marginBottom: 8 }}>← Programmes</Link>
      </div>
