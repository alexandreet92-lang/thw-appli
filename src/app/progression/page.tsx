  ...
  return (
    <div className="prog-hub">
      <style>{`
        ...
        .prog-conn { stroke: rgba(148,163,184,0.22); stroke-width: 1; stroke-dasharray: 4 4; animation: prog-dash 6s linear infinite; }
        @keyframes prog-dash { to { stroke-dashoffset: -20; } }
      ...
      <svg viewBox="0 0 100 100" preserveAspectRatio="none" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', zIndex: 1 }}>
        {SPORTS.map(s => <line key={s.id} className="prog-conn" x1={50} y1={50} x2={s.x} y2={s.y} />)}
      </svg>
