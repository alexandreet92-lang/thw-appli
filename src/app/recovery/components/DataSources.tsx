...
const SOURCES = [
  { id:'strava', name:'Strava', connected:true,  lastSync:'Il y a 2h',   types:['Activités','Vitesse','Distance','Puissance'] },
  { id:'garmin', name:'Garmin', connected:false, lastSync:null,           types:['Activités','Sommeil','HRV','SpO2','FC'] },
