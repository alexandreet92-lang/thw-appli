...
interface Act { started_at: string; sport_type: string; moving_time_s: number | null; distance_m: number | null; tss: number | null; title: string | null }
...
export function MonthlySummary({ activities }: { activities: Act[] }) {
  const now = new Date()
