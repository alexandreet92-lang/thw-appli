'use client'
// ══════════════════════════════════════════════════════════════════
// CoachSettingsModal — réglages coach en SUR-PAGE centrée (façon Claude),
// par-dessus l'app assombrie. Desktop uniquement (hidden md:flex) — monté
// dans DesktopShell, ouvert au clic sur l'avatar de la sidebar coach ou via
// l'event `thw:open-coach-settings`. Réutilise CoachSettingsContent (même
// liste + drill-down que le mobile) — miroir exact de ProfileModalDesktop.
// ══════════════════════════════════════════════════════════════════
import { Suspense, useEffect, useState } from 'react'
import { CoachSettingsContent } from '@/app/coach/settings/page'

export function CoachSettingsModal({ open, onClose }: { open: boolean; onClose: () => void }) {
