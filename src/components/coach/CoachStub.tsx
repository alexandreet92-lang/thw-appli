...
export function CoachStub({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 20px', textAlign: 'center', fontFamily: 'var(--font-body)' }}>
      ...
      <h1 style={{ fontSize: 22, fontWeight: 800, color: 'var(--text)', margin: '0 0 8px', fontFamily: 'var(--font-display)' }}>{title}</h1>
