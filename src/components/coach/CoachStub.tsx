...
export function CoachStub({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 20px', textAlign: 'center', fontFamily: 'DM Sans,sans-serif' }}>
      <span style={{ width: 56, height: 56, borderRadius: 16, background: 'color-mix(in srgb, #3B92D4 12%, transparent)', color: '#3B92D4', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
