...
const MESSAGES = [
  { role: 'user', text: 'onboarding.chatMsg1', delay: 200 },
  { role: 'ai', text: 'onboarding.chatMsg2', delay: 1200 },
  { role: 'user', text: 'onboarding.chatMsg3', delay: 2800 },
  { role: 'ai', text: 'onboarding.chatMsg4', delay: 3800 },
]
  ...
  return (
    <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: 18, padding: 14, width: '100%', maxWidth: 300, border: '1px solid rgba(255,255,255,0.08)', display: 'flex', flexDirection: 'column', gap: 8, minHeight: 170 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 600, color: '#8b5cf6', fontFamily: 'DM Sans, sans-serif' }}>{t('onboarding.aiCoach')}</span>
      </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, padding: '0 24px', gap: 28 }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <h2 style={{ fontSize: 26, fontWeight: 800, color: '#fff', margin: '0 0 10px', fontFamily: 'Syne, sans-serif' }}>{t('onboarding.aiTitle')}</h2>
        <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.58)', lineHeight: 1.6, margin: 0, fontFamily: 'DM Sans, sans-serif' }}>{t('onboarding.aiSub1')}<br />{t('onboarding.aiSub2')}</p>
      </div>
    </div>
  )
}
