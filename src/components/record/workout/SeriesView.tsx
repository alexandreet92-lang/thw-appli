  ...
  return (
    <div style={{ padding: '20px 20px', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <p style={{ fontSize: 13, color: dim, margin: '0 0 20px' }}>
        Série {done ? exercise.sets : currentSet + 1} / {exercise.sets}
      </p>
      ...
      {done ? (
        ...
        <>
          ...
          <div style={{ marginBottom: 20 }}>
            <p style={{ fontSize: 11, color: dim, textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 10px' }}>Répétitions</p>
          ...
          <div style={{ marginBottom: 28 }}>
            <p style={{ fontSize: 11, color: dim, textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 10px' }}>Charge (kg)</p>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
