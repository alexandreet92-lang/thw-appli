...
const NAV = [
  ...
  // « Découvrir » (/feed) retiré de la nav : le feed d'activités façon Strava
  // n'est pas notre valeur pour l'instant. La page /feed existe toujours ;
  // on la réactivera avec une grosse communauté (cf. Challenges Notion).
  {
    href: '/coaches',
