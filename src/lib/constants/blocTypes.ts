...
export const SPORT_LABELS: Record<string, string> = {
  velo: 'Vélo', running: 'Running', trail: 'Trail', hyrox: 'Hyrox', natation: 'Natation', muscu: 'Muscu', boxe: 'Boxe', hybrid: 'Hybrid',
}

// Teintes sport (immuables, sanctionnées) — utilisées via cette constante, jamais en dur.
export const SPORT_COLORS: Record<string, string> = {
  velo: '#3b82f6', running: '#22c55e', trail: '#84cc16', hyrox: '#ec4899', natation: '#0ea5b7', muscu: '#f97316', boxe: '#e11d48', hybrid: '#f59e0b',
}

export const BLOC_SPORT_KEYS = ['velo', 'running', 'trail', 'hyrox', 'natation', 'muscu', 'boxe', 'hybrid'] as const
