...
export interface CoachPack {
  ...
  maxAthletes: number
  /**
   * Tokens Studio mensuels inclus. PROPORTIONNEL à la capacité d'athlètes :
   * un run Studio s'exécute PAR athlète (1 système → N athlètes, un rendu
   * chacun), donc le budget doit suivre le roster — sinon le pack Fédération
   * ne peut pas faire tourner son système une seule fois sur ses 500 athlètes.
   * Base : 50 000 tokens par athlète, plancher à 1 M (pack Solo).
   * Le budget de CHAT, lui, ne dépend pas du pack (un coach a le même nombre
   * d'heures dans sa journée) : il vient de la formule Premium/Pro/Expert.
   */
  studioTokens: number
...
export const COACH_PACKS: CoachPack[] = [
  ...
  { key: 'coach50', name: 'Équipe', label: "Jusqu'à 50 athlètes", maxAthletes: 50, studioTokens: 2_500_000, tiers: {
  ...
  { key: 'coach100', name: 'Club', label: "Jusqu'à 100 athlètes", maxAthletes: 100, studioTokens: 5_000_000, tiers: {
  ...
  { key: 'coach200', name: 'Académie', label: "Jusqu'à 200 athlètes", maxAthletes: 200, studioTokens: 10_000_000, tiers: {
  ...
  { key: 'coach300', name: 'Élite', label: "Jusqu'à 300 athlètes", maxAthletes: 300, studioTokens: 15_000_000, tiers: {
  ...
  { key: 'coach500', name: 'Fédération', label: "Jusqu'à 500 athlètes", maxAthletes: 500, studioTokens: 25_000_000, tiers: {
