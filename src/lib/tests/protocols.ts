// ══════════════════════════════════════════════════════════════════
// Catalogue COMPLET des tests de performance + protocoles détaillés.
// Source de vérité unique, partagée par la page Performance, le Calendrier
// (objectif « Test ») et le Planning (planifier un test). Chaque test porte
// son id, son nom, sa durée, sa difficulté et — quand défini — son protocole
// complet (objectif, conditions, échauffement, étapes, erreurs, fréquence).
// ══════════════════════════════════════════════════════════════════
import type { TestSport, FieldDef } from '@/app/performance/testTypes'
...
export const DIFFICULTY_COLOR: Record<TestDef['difficulty'], string> = {
  'Modéré': '#22c55e', 'Intense': '#f59e0b', 'Maximal': '#ef4444',
}

// Sport du test → code sport planned_sessions.
export const TEST_SPORT_TO_PLANNING: Record<TestSport, string> = {
  running: 'run', cycling: 'bike', natation: 'swim', aviron: 'rowing', hyrox: 'hyrox',
}

export const TESTS: Record<TestSport, TestDef[]> = {
  running: [
...
export const PROTOCOLS: Record<string, TestProtocol> = {
  // ── Running ─────────────────────────────────
  'vo2max-run': {
